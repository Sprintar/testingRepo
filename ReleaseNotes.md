...
- **[P2] SPIKE: Release Branch Controls** - Documented the current release process and proposed a new versioning process. Key changes include replacing the `release` branch with tags, implementing structured versioning patterns (major, minor, service packs), and managing Docker images with version-specific tags.  
